...
func (frame *FlushFrame) write(f *Framer) error {
	return nil
}

func (frame *FinFrame) write(f *Framer) error {
	return nil
}

func (frame *PanicFrame) write(f *Framer) error {
	return nil
}
...
func (f *Framer) writeSynReplyFrame(frame *SynReplyFrame) (err error) {
	...
	if headerLen, err = writeHeaderValueBlock(writer, frame.Headers); err != nil {
		return
	}
	if !f.headerCompressionDisabled {
		f.headerCompressor.Flush()
