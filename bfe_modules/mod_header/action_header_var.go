...
var VariableHandlers = map[string]HeaderValueHandler{
	...
	"client_cert_subject_organization_unit": getClientCertSubjectOrganizationUnit,
	"client_cert_subject_provice":           getClientCertSubjectProvice,
...
func getClientCertSubjectOrganizationUnit(req *bfe_basic.Request) string {
	clientCert := getClientCert(req)
	if clientCert == nil {
		return ""
	}
...
func getClientCertSubjectProvice(req *bfe_basic.Request) string {
	clientCert := getClientCert(req)
	if clientCert == nil {
		return ""
	}
