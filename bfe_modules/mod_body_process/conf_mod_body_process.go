...
func (cfg *ConfModBodyProcess) Check(confRoot string) error {
	if cfg.Basic.ProductRulePath == "" {
		log.Logger.Warn("ModBodyProcess.ProductRulePath not set, use default value")
		cfg.Basic.ProductRulePath = "mod_body_process/body_process.data"
	}
