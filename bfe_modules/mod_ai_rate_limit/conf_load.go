...
type ConfModAiRateLimit struct {
	Basic struct {
...
func ConfLoad(filePath string, confRoot string) (*ConfModAiRateLimit, error) {
	var cfg ConfModAiRateLimit
	var err error
...
func (cfg *ConfModAiRateLimit) Check(confRoot string) error {
	return ConfModAiRateLimitCheck(cfg, confRoot)
}

func ConfModAiRateLimitCheck(cfg *ConfModAiRateLimit, confRoot string) error {
	// check ProductRulePath
	if cfg.Basic.ProductRulePath == "" {
		return fmt.Errorf("ConfModAiRateLimitCheck ProductRulePath is nil")
	}
