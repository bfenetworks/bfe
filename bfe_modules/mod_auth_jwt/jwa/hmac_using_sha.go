...
func NewHS(factory HashFactory, mJWK *jwk.JWK) (hs *HS, err error) {
	if mJWK.Kty != jwk.OCT {
...
func NewHS256(mJWK *jwk.JWK) (hs *HS, err error) {
	return NewHS(sha256.New, mJWK)
}

func NewHS384(mJWK *jwk.JWK) (hs *HS, err error) {
	return NewHS(sha512.New384, mJWK)
}

func NewHS512(mJWK *jwk.JWK) (hs *HS, err error) {
