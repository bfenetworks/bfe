...
var funcProtos = map[string][]Token{
	...
	"req_query_value_contain":    []Token{STRING, STRING, BOOL},
	"req_query_value_hash_in":    []Token{STRING, STRING, BOOL},
	...
	"req_cookie_value_contain":   []Token{STRING, STRING, BOOL},
	"req_cookie_value_hash_in":   []Token{STRING, STRING, BOOL},
	"req_port_in":                {STRING},
	...
	"req_header_value_contain":   []Token{STRING, STRING, BOOL},
	"req_header_value_hash_in":   []Token{STRING, STRING, BOOL},
	"req_method_in":              {STRING},
	"req_cip_range":              {STRING, STRING},
	"req_vip_range":              {STRING, STRING},
	"req_cip_hash_in":            []Token{STRING},
	"res_code_in":                {STRING},
