...
// TimeMatcher time range matcher
...
// PeriodicTimeMatcher periodic time range matcher
...
// NewPeriodicTimeMatcher time string format: hhmmssZ, example 150405H, Z-> timezone defined in bfe_util.TimeZoneMap
