...
| H2_CONN_OVERLOAD            | Counter for HTTP2 connection overload                  |
| H2_REQ_OVERLOAD             | Counter for HTTP2 request overload                     |
| H2_CONN_EXCEED_MAX_QUEUED_CONTROL_FRAMES | Counter for exceeding max queued control frames |
...
| H2_TIMEOUT_CONN             | Counter for HTTP2 connection timeout                    |
