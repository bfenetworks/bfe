...
| SPDY_ERR_GOT_RESET             | Counter for getting RST_STREAM                          |
...
| SPDY_ERR_STREAM_CANCEL         | Counter for stream cancelled                            |
...
| SPDY_REQ_HEADER_COMPRESS_SIZE  | Size of request header after compress                   |
| SPDY_REQ_HEADER_ORIGINAL_SIZE  | Size of request header before compress                  |
| SPDY_RES_HEADER_COMPRESS_SIZE  | Size of response header after compress                  |
| SPDY_RES_HEADER_ORIGINAL_SIZE  | Size of response header before compress                 |
| SPDY_TIMEOUT_CONN              | Counter for SPDY connection timeout                     |
...
| SPDY_REQ_OVERLOAD              | Counter for SPDY request overload                       |
| SPDY_CONN_OVERLOAD             | Counter for SPDY connection overload                    |
