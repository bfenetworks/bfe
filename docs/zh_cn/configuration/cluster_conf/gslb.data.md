...
| 配置项   | 描述                                            |
| -------- | ---------------------------------------------- |
| Hostname | String<br>配置文件生成来源信息（必填）                            |
| Ts       | String<br>配置文件生成的时间戳（必填）                            |
...
| Clusters{v}{v} | Integer<br>子集群承接流量的权重<br>各子集群正权重之和须大于0，BFE按权重比例进行分流；不强制要求取值范围0～100，也不要求权重之和等于100 |
