...
| Basic.ConnPoolSize            | Integer<br> 与WAF server 的连接池大小 |
...
| Config.WafCluster[].Port | Integer<br> WAF RS 攻击检测端口 |
| Config.WafCluster[].HealthCheckPort | Integer<br> WAF RS 健康检测端口 |
